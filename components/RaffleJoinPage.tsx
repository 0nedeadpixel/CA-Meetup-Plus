                        ...
                        <MotionDiv initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-6 backdrop-blur-sm">
                            <MotionDiv initial={{ scale: 0.9 }} animate={{ scale: 1 }} className="bg-gray-900 border border-gray-800 p-6 w-full max-w-sm shadow-2xl">
                                ...
                                <div className="space-y-4 mb-6">
                                    <div><label className="text-xs text-gray-500 font-bold uppercase ml-1 mb-1 block">Trainer Name (IGN)</label><input type="text" value={editIgn} onChange={(e) => setEditIgn(e.target.value)} className="w-full bg-gray-950 border border-gray-800 p-3 text-white outline-none focus:border-purple-500" maxLength={16} /></div>
                                    <div><label className="text-xs text-gray-500 font-bold uppercase ml-1 mb-1 block">Your Name</label><input type="text" value={editName} onChange={(e) => setEditName(e.target.value)} className="w-full bg-gray-950 border border-gray-800 p-3 text-white outline-none focus:border-purple-500" maxLength={16} /></div>
                                </div>
