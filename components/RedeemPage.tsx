      ...
      <div className="flex flex-col items-center pt-6 pb-2">
          ...
          {status === 'success' && (
            <MotionDiv initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full text-center">
                <div className="flex justify-center mb-4">
                    <img src="https://app.fullertonpogo.com/img/happy-pika.gif" className="w-32 h-32 object-contain drop-shadow-lg" alt="Happy Pika" />
                </div>
          ...
          {status === 'waiting_fix' && (
            <MotionDiv initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="w-full text-center py-4">
                <div className="flex justify-center mb-4">
                    <img src="https://app.fullertonpogo.com/img/pika-sad.gif" className="w-32 h-32 object-contain drop-shadow-lg opacity-90" alt="Waiting" />
                </div>
          ...
          {status === 'empty' && (
            <div className="flex flex-col items-center space-y-4 py-4">
                <img src="https://app.fullertonpogo.com/img/pika-nomo.gif" className="w-32 h-32 object-contain drop-shadow-lg mb-4" alt="Empty" />
          ...
          {status === 'limit_reached' && (
            <div className="flex flex-col items-center space-y-4 py-4 px-2">
                <img src="https://app.fullertonpogo.com/img/pika-nomo.gif" className="w-32 h-32 object-contain drop-shadow-lg mb-4" alt="Limit Reached" />
          ...
          {status === 'error' && (
            <div className="flex flex-col items-center space-y-4 py-4 px-2">
                <img src="https://app.fullertonpogo.com/img/pika-sad.gif" className="w-32 h-32 object-contain drop-shadow-lg mb-4 opacity-80" alt="Error" />
