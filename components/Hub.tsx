            ...
            >
              ...
              <div className="space-y-3 relative z-20">
                ...
                <Button 
                  ...
                  className="bg-[#5865F2] hover:bg-[#4752C4] text-white border-none relative overflow-hidden group h-14"
                >
                  {/* Giant faded Discord SVG */}
                  <svg 
                    role="img" 
                    viewBox="0 0 24 24" 
                    xmlns="http://www.w3.org/2000/svg" 
                    className="absolute -left-4 -bottom-4 w-24 h-24 text-white opacity-10 group-hover:scale-110 group-hover:-rotate-12 transition-transform duration-500 pointer-events-none"
                    fill="currentColor"
                  >
                ...
                <Button 
                  ...
                  variant="ghost" 
                  onClick={() => setShowDiscordPrompt(false)} 
                  className="text-gray-500 hover:text-white relative overflow-hidden group h-12 bg-gray-800/30 hover:bg-gray-800/60"
                >
                  {/* Giant faded Clock icon from Lucide */}
                  <Clock size={64} className="absolute -right-4 -top-2 text-gray-500 opacity-10 group-hover:opacity-20 group-hover:-rotate-12 transition-all duration-500 pointer-events-none" />
